...
export const metadata = {
  title: "Live Transactions |NairaToCrypto",
  description: "Experience instant Naira to USDT conversion. Send Naira and watch it convert to Base Sepolia USDT in real-time. No P2P required.",
  openGraph: {
    title: "Live Transactions | NairaToCrypto",
    description: "Watch Real-Time Naira to USDT Conversion",
    type: "website",
    url: "https://nairacrypto.vercel.app/transactions",
  },
};
      ...
      <div className="container mx-auto p-4 space-y-8">
        <Alert className="bg-blue-50 border-blue-200">
          ...
          <AlertDescription className="text-blue-600">
            Witness the power of automated cryptocurrency conversion! Send a minimum of 120 Naira to either of the demo accounts below and watch as
            it's instantly converted to Base Sepolia USDT to the respective address, no p2p.
          </AlertDescription>
        </Alert>
